...
const ContactUs = () => {
  return (
    <div className="wrapper w-full">
      <div className="contactUsWrap p-6 md:p-16 backdrop-brightness-50 bg-black/40">

        {/* Heading */}
        <div className="text-center text-white mb-10">
          <h1 className="mb-4 text-44 font-bold">Contact Us</h1>
          <p className="text-xl md:text-2xl">
            For all project inquiries, email <b>email@gmail.com</b> with the subject NEW PROJECT
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-10 md:gap-20">
          ...
          {/* Left Info Section */}
          <div className="flex flex-col gap-8 text-white max-w-sm">
            ...
            <div className="flex gap-5 items-center">
              <div className="w-12 h-12 flex items-center justify-center bg-white rounded-lg p-2">
                <img src="./assets/images/telephone (1).png" alt="phone icon" />
              </div>
              <div>
            ...
            <div className="flex gap-5 items-center">
              <div className="w-12 h-12 flex items-center justify-center bg-white rounded-lg p-2">
                <img src="./assets/images/mail (1).png" alt="email icon" />
              </div>
              <div>
